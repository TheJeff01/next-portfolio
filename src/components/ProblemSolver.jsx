...
const data = [
  {
    ...
    text:
      "Holder of a Bachelor’s Degree in Computer Science from Coal City University, Enugu State.",
  },
  {
    boxicon: <MdCheckBoxOutlineBlank />,
    text:
      "Skilled in React.js and Next.js, with a passion for staying ahead of the curve through continuous learning and adoption of emerging technologies.",
  },
  {
    boxicon: <MdCheckBoxOutlineBlank />,
    text:
      "I love working in a team environment, but I can also work independently.",
  },
];
